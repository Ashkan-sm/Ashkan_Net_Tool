...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v1.9.0"
  WORKING_DIRECTORY "/media/dev/H/projects/pcap/PcapPlusPlus-25.05/cmake-build-debug/_deps/benchmark-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: v1.9.0")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"v1.9.0\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/media/dev/H/projects/pcap/PcapPlusPlus-25.05/cmake-build-debug/_deps/benchmark-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/media/dev/H/projects/pcap/PcapPlusPlus-25.05/cmake-build-debug/_deps/benchmark-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
