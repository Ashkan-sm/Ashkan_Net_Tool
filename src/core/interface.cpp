...
void ashk::ModelInterface::start_arp_poison(const std::string &iface_ip,
...
void ashk::ModelInterface::start_mitm_forwarding(const std::string &iface_ip_str,
...
void ashk::ModelInterface::start_vlan_hopping(const std::string &iface_ip_str,
...
void ashk::ModelInterface::start_password_cracking(const std::string &iface_ip_name_str,
