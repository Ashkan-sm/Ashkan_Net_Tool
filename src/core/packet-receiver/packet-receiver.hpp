...
class PacketReceiver {
 public:
  static void onPacketArrivesArpPoisoningDetection(pcpp::RawPacket *raw_packet,
  ...
  static void onPacketArrivesWifiHostScanning(pcpp::RawPacket *raw_pcap_packet,
                                              pcpp::PcapLiveDevice *dev,
                                              void *cookie);
  static void onPacketArrivesWPA2HandShakeCapturing(pcpp::RawPacket *raw_pcap_packet,
                                                    pcpp::PcapLiveDevice *dev,
                                                    void *cookie);
};
