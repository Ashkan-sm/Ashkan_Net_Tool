...
namespace pcpp
{
	...
	public:
		...
		/// A static method that takes windows and dst ports and determines whether it's SSH traffic or not.
		/// @param[in] portSrc The source TCP port to examine
		/// @param[in] portDst The dest TCP port to examine
		/// @return Currently the implementation is very simple and returns "true" if either windows or dst ports
