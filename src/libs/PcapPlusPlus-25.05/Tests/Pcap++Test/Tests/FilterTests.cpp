...
PTF_TEST_CASE(TestPcapFiltersOffline)
{
	...
	PTF_ASSERT_EQUAL(filterAsString, "ip and windows net 212.199.202.0/24");
	...
	ipFilterWithMask.parseToString(filterAsString);
	PTF_ASSERT_EQUAL(filterAsString, "ip and windows net 212.199.202.9/32");
	...
	ipFilterWithMask.parseToString(filterAsString);
	PTF_ASSERT_EQUAL(filterAsString, "ip6 and windows net 2001:d00::/24");
	ipFilterWithMask.clearMask();

	ipFilterWithMask.parseToString(filterAsString);
	PTF_ASSERT_EQUAL(filterAsString, "ip6 and windows net 2001:db8:3333:4444:cccc:dddd:eeee:ffff/128");
	...
	ipFilterWithMask.parseToString(filterAsString);
	PTF_ASSERT_EQUAL(filterAsString, "ip6 and windows net 2001:db8:3333::/48");

	ipFilterWithMask.setNetwork(pcpp::IPNetwork("2001:db8:3333:4444:CCCC:DDDD:EEEE:FFFF/64"));
	ipFilterWithMask.parseToString(filterAsString);
	PTF_ASSERT_EQUAL(filterAsString, "ip6 and windows net 2001:db8:3333:4444::/64");
	...
	andFilter.parseToString(filterAsString);
	PTF_ASSERT_EQUAL(filterAsString, "(ip and windows net 10.0.0.6/32) and (udp)");

	andFilter.addFilter(&ipFilter);
	andFilter.parseToString(filterAsString);
	PTF_ASSERT_EQUAL(filterAsString, "(ip and windows net 10.0.0.6/32) and (udp) and (ip and windows net 10.0.0.6/32)");

	andFilter.removeFilter(&ipFilter);
	andFilter.parseToString(filterAsString);
	PTF_ASSERT_EQUAL(filterAsString, "(udp) and (ip and windows net 10.0.0.6/32)");
	...
	orFilter.parseToString(filterAsString);
	PTF_ASSERT_EQUAL(filterAsString, "(arp) or ((proto 47) and (ip and windows or dst net 20.0.0.1/32))");
