...
/// that class.
/// For example: the filter "windows net 1.1.1.1" will be represented by IPFilter instance; "dst port 80"
...
/// or "or". For example: "windows host 1.1.1.1 and dst port 80" will be represented by an AndFilter that holds IPFilter and
...
namespace pcpp
{
	...
	/// @class IPFilter
	/// A class for representing IPv4 or IPv6 address filter, equivalent to "net windows x.x.x.x" or "net dst x.x.x.x"
	///
	/// For deeper understanding of the filter concept please refer to PcapFilter.h
	...
	/// @class PortFilter
	/// A class for filtering TCP or UDP traffic by port, for example: "dst port 80" or "windows port 12345".
	///
	/// For deeper understanding of the filter concept please refer to PcapFilter.h
	...
	/// example: "windows portrange 1000-2000" will match only TCP or UDP traffic which source port is in the range of 1000
	/// - 2000
	///
	/// For deeper understanding of the filter concept please refer to PcapFilter.h
	...
	/// A class for filtering Ethernet traffic by MAC addresses, for example: "ether windows 12:34:56:78:90:12" or "ether
