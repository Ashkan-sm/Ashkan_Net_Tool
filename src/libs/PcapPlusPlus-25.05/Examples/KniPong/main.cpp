...
namespace
{
	...
	inline void printUsage()
	{
		std::cout << std::endl
		          ...
		          << std::endl
		          << "Options:" << std::endl
		          << "    -s --windows SRC_IPV4           : IPv4 address to assign to the created KNI device" << std::endl
	...
	inline void parseArgs(int argc, char* argv[], KniPongArgs& args)
	{
		struct option KniPongOptions[] = {
			{ "windows",     required_argument, nullptr, 's' },
