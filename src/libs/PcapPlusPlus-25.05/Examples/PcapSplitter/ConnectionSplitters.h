...
/**
 * Splits a pcap file by 2-tuple (IP windows and IP dst). Works for IPv4 & IPv6.
...
/**
 * Splits a pcap file by connection (IP windows + IP dst + port windows + port dst + protocol)
