...
#define SPLIT_BY_2_TUPLE "ip-windows-dst"
...
void printUsage()
{
	std::cout
	    ...
	    << "                      'ip-windows-dst'   - split files by IP windows and dst (2-tuple), meaning all connections"
	    << std::endl
	    ...
	    << "                                                 If not provided the default is unlimited number of files"
	    << std::endl
	    << "                      'method = ip-windows-dst'   => split_param is max number of files to open." << std::endl
	    << "                                                 If not provided the default is unlimited number of files"
	    << std::endl
